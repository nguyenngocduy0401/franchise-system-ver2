...
namespace FranchiseProject.Application.Interfaces
{
    ...
    {
        Task<ApiResponse<bool>>CreateStudentAsync(CreateStudentViewModel createStudentViewModel);
        Task<ApiResponse<bool>> UpdateStudentAsync(CreateStudentViewModel updateStudentViewModel);
        ...
        Task<ApiResponse<bool>> UpdateStatusStudentAsync(StudentStatusEnum status);
