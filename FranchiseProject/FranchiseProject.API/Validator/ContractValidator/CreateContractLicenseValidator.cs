...
{
    public class CreateContractLicenseValidator : AbstractValidator<CreateContractLicenseModel>
    {
        public CreateContractLicenseValidator()
        {
            RuleFor(x => x.Title)
                    .MaximumLength(50)
            ...
            RuleFor(x => x.CreatePackageModel)
            .SetValidator(new CreatePackageValidator());
