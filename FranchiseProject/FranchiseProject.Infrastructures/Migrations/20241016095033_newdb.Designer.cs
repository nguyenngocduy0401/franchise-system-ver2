...
namespace FranchiseProject.Infrastructures.Migrations
{
    ...
    [Migration("20241016095033_newdb")]
    partial class newdb
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FranchiseProject.Domain.Entity.Contract", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreationDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Duration = 0,
                            EndTime = new DateTime(2024, 10, 21, 16, 50, 32, 268, DateTimeKind.Local).AddTicks(2255),
                            IsDeleted = false,
            ...
            modelBuilder.Entity("FranchiseProject.Domain.Entity.Course", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("be37023d-6a58-4b4b-92e5-39dcece45412"),
                            CreationDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsDeleted = false,
                            Name = "C# basic",
                            Status = 0
                        ...
                        new
                        {
                            Id = new Guid("be37023d-6a58-4b4b-92e5-39dce1231313"),
                            CreationDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsDeleted = false,
                            Name = "JAVA",
                            Status = 0
            ...
            modelBuilder.Entity("FranchiseProject.Domain.Entity.Payments", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FranchiseProject.Domain.Entity.Student", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FranchiseProject.Domain.Entity.Payments", b =>
                {
                    ...
                    b.HasOne("FranchiseProject.Domain.Entity.Student", null)
                        .WithMany("Payments")
            ...
            modelBuilder.Entity("FranchiseProject.Domain.Entity.StudentCourse", b =>
                {
                    ...
                    b.HasOne("FranchiseProject.Domain.Entity.Student", "Student")
                        .WithMany("StudentCourses")
                        .HasForeignKey("StudentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
