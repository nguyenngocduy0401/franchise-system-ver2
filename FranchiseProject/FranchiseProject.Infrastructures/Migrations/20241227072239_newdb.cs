    ...
    public partial class newdb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    FranchiseTitle = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FranchiseDescription = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FranchiseBannerImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FranchiseMainContent = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CourseTitle = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CourseDescription = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CourseBannerImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CourseMainContent = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "AgencyVnPayInfos",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TmnCode = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    HashSecret = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AgencyVnPayInfos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AgencyVnPayInfos_Agencies_AgencyId",
                        column: x => x.AgencyId,
            ...
            migrationBuilder.CreateTable(
                name: "UserChapterMaterials",
                columns: table => new
                {
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ChapterMaterialId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CompletedDate = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserChapterMaterials", x => new { x.ChapterMaterialId, x.UserId });
                    table.ForeignKey(
                        name: "FK_UserChapterMaterials_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserChapterMaterials_ChapterMaterials_ChapterMaterialId",
                        column: x => x.ChapterMaterialId,
                        principalTable: "ChapterMaterials",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("be37023d-6a58-4b4b-92e5-39dcece45473"), 0, null, null, null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, null, null, false, null, null, "Nguyễn Hồng", null, null, null, 1, null });
            ...
            migrationBuilder.InsertData(
                table: "Contracts",
                columns: new[] { "Id", "AgencyId", "ContractCode", "ContractDocumentImageURL", "CreatedBy", "CreationDate", "DeleteBy", "DeletionDate", "DepositPercentage", "EndTime", "FrachiseFee", "IsDeleted", "ModificationBy", "ModificationDate", "PackageId", "PaidAmount", "RevenueSharePercentage", "StartTime", "Status", "Title", "Total" },
                values: new object[] { new Guid("550ee872-ea09-42a0-b9ac-809890debafb"), null, null, null, null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, null, new DateTime(2025, 1, 1, 14, 22, 37, 823, DateTimeKind.Local).AddTicks(9863), null, false, null, null, null, null, null, null, null, null, null });
            ...
            migrationBuilder.InsertData(
                table: "HomePages",
                columns: new[] { "Id", "ContactEmail", "CourseBannerImageUrl", "CourseDescription", "CourseMainContent", "CourseTitle", "CreatedBy", "CreationDate", "DeleteBy", "DeletionDate", "FranchiseBannerImageUrl", "FranchiseDescription", "FranchiseMainContent", "FranchiseTitle", "IsDeleted", "ModificationBy", "ModificationDate", "PhoneNumber" },
                values: new object[] { new Guid("550ee872-ea09-42a0-b9ac-809890debafb"), null, null, null, null, null, null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, null, null, null, null, false, null, null, null });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AgencyVnPayInfos_AgencyId",
                table: "AgencyVnPayInfos",
                column: "AgencyId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserChapterMaterials_UserId",
                table: "UserChapterMaterials",
                column: "UserId");
        }
